...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v242t0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v242t0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Pissolato32/container-v242t0.git
cd container-v242t0
```
...
```
docker attach container-v242t0
```
